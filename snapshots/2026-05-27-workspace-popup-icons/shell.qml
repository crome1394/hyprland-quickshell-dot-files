...
PanelWindow {
    ...
    PopupWindow {
        ...
        implicitHeight: {
            ...
            const base = 46;
            return Math.max(60, Math.min(220, base + count * 22));
        }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                // Window list with application icons (sourced via Quickshell.iconPath + window class)
                ColumnLayout {
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    spacing: 4
                ...
                // Extra bottom breathing room so the last app line isn't touching the popup border
                Item {
