                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    if (addr) {
                                        // Best approach: focuswindow by address will automatically
                                        // switch to the window's workspace and focus it.
                                        // This avoids race conditions between separate workspace + focus dispatches.
                                        Hyprland.dispatch(`focuswindow address:0x${addr}`);
                                    } else if (bar.hoveredWorkspace && bar.hoveredWorkspace.activate) {
                                        // Fallback if we don't have a window address for some reason
