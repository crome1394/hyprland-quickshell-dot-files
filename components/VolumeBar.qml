...
Item {
    ...
    property color fill:     (bar && bar.sliderFill)  ? bar.sliderFill  : (t ? t.sliderFill     : "#00F0E0")
    property color track:    (bar && bar.sliderTrack) ? bar.sliderTrack : (t ? t.sliderTrack    : "#141a24")
