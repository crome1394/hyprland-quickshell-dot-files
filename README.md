...
- **Control strip** — right-click empty chrome or **Config menu** gear: layout, wallpaper, Options, Quick Launch, XDG Autostart, systemd Services, Keybinds editor, clock formats
